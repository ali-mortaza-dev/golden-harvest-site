...
function App() {
  ...
  const CHAT_LOGIC = {
    greetings: [
      "ওয়ালাইকুম আসসালাম ভাই! 🍯 সিকদার এআই আপনার সেবায় হাজির। আড্ডা দিন মন খুলে। কোনো অফার লাগবে নাকি? 😂",
      "সালাম! 🐝 কি খবর ভাই? মধুর মতো মিষ্টি একটা দিন কাটাতে চান নাকি? 😎",
      "হেলো হেলো! 🚀 সিকদার এআই-এর ডিজিটাল ঘরে আপনাকে স্বাগতম। কিছু কি অর্ডার করবেন? 💥"
    ],
    privacy: [
    ...
    default: [
      "হাহাহা! 🍯 আপনার কথা শুনে আমার ডিজিটাল কলিজা জুড়িয়ে গেল। 😂 সিকদার এআই-এর সাথে থাকুন, আনন্দ পাবেন! 🚀",
      "উফ! ভাই আপনি তো হেব্বি রসিক মানুষ। 😂 মধুর মতো মিষ্টি কথাবার্তা! 🍯",
      "হুমমম... আপনার কথা শুনে মৌমাছিরাও কনফিউজ হয়ে গেছে! 🐝 কিন্তু সিকদার এআই সবসময় রেডি! 😎💥",
      "ভাই, আপনি তো ডিজিটাল দুনিয়ার রকেট! 🚀 আরও কিছু বলুন, শুনতে ভালো লাগছে। 😂"
    ]
  };
    ...
    setTimeout(() => {
      ...
      if (lower.includes("আমার নাম") || lower.includes("i am") || lower.includes("im ")) {
        ...
        if (parts.length > 1) {
          ...
          setUserName(name);
          response = `${name} ভাই! 🍯 দারুন নাম তো আপনার। একদম মধুর মতো নাম! 😂 কি সেবা করতে পারি? 🚀`;
        }
      }
      ...
      if (!response) {
        ...
        if (userName && Math.random() > 0.5) {
          response = `${userName} ভাই, ` + response;
        }
      }
      ...
      <footer className="footer" id="contact">
        <div className="footer-content">
          ...
          <div className="social-icons-footer">
            ...
            <button className="social-icon-link ai-toggle" onClick={() => setIsChatOpen(!isChatOpen)} style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer' }}>
              <span className="ai-logo" style={{ fontSize: '1.2rem' }}>Ai</span>
            </button>
          </div>
        </div>
